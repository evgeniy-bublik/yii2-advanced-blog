...
<div class="topbar">
    ...
    <div class="topbar-left">
        ...
        <!-- Image logo -->
        <a href="<?= Url::toRoute(['/core/index/index']); ?>" class="logo">
            <span>
                <img src="<?= $this->theme->getUrl('//images/logo.png'); ?>" alt="" height="25">
            </span>
            <i>
                <img src="<?= $this->theme->getUrl('//images/logo_sm.png'); ?>" alt="" height="28">
            </i>
        </a>
    </div>
        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown user-box">
                    ...
                    <img src="<?= $this->theme->getUrl('/images/users/avatar-1.jpg'); ?>" alt="user-img" class="img-circle user-img">
                    </a>
                    <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?= Url::toRoute(['/user/security/logout']); ?>" data-method="post">Logout</a>
                        </li>
                    </ul>
                </li>
            </ul>
