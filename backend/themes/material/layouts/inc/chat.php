    ...
    <div class='chat-wrapper scrollbar'>
        <div class='chat-message scrollbar'>
            <div class='chat-message chat-message-recipient'>
                <img class='chat-image chat-image-default' src="<?= Yii::$app->view->theme->getUrl('/img/profiles/05.jpg'); ?>"/>
            ...
            <div class='chat-message chat-message-sender'>
                <img class='chat-image chat-image-default' src="<?= Yii::$app->view->theme->getUrl('/img/profiles/02.jpg'); ?>"/>
                <div class='chat-message-wrapper '>
                    <div class='chat-message-content'>
